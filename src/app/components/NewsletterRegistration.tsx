        ...
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
          ...
          {!formSent ? (
            <p className="mx-auto mt-6 max-w-lg text-center text-lg text-gray-300">
              You can easily register with your eamil to always get all the
              latest information
            </p>
          ) : (
            <></>
          ...
          {!formSent ? (
            <form
              className="mx-auto mt-10 flex max-w-4xl gap-x-4"
              action={Register}
            >
              <input
                required
              ...
              <button
                ...
                type="submit"
                className={
                  (formSent ? "bg-gray-700 " : "bg-white hover:bg-gray-100 ") +
                  "flex-none rounded-md px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                }
              >
                Notify me{" "}
